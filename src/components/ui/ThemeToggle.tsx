...
export function ThemeToggle({ className }: { className?: string }) {
  ...
  return (
    ...
    >
      <Sun
        className={cn(
          "absolute start-[7px] top-1/2 h-4 w-4 -translate-y-1/2 transition-colors duration-200",
          isDark ? "text-muted" : "text-foreground",
        )}
      />
      <Moon
        className={cn(
          "absolute end-[7px] top-1/2 h-4 w-4 -translate-y-1/2 transition-colors duration-200",
      ...
      <span
        className={cn(
          ...
          "bg-accent text-accent-foreground shadow-sm transition-transform duration-200 ease-out",
          isDark
